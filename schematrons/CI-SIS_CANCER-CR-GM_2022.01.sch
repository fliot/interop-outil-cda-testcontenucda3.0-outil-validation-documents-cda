...
<!-- 
   CI-SIS_CANCER-CR-GM_2022.01.sch
   auteur : ANS
   ...
   ......................................................................................................................................................    
    Historique :
       ...
       11/04/2022:  Migration des terminologies et JDV en SNOMED-CT
       -->

<schema xmlns="http://purl.oclc.org/dsdl/schematron" defaultPhase="CI-SIS_CANCER-CR-GM_2022.01"
        xmlns:cda="urn:hl7-org:v3" queryBinding="xslt2"
        xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
        schemaVersion="CI-SIS_CANCER-CR-GM_2022.01.sch">
        <title>Rapport de conformité du document aux spécifications du volet
                CANCER-CR-GM_2022.01</title>
        ...
        <include href="include/specificationsVolets/CANCER-CR-GM_2022.01/Sections/S_additionalSpecified_CRGM.sch"/>
        <include href="include/specificationsVolets/CANCER-CR-GM_2022.01/Sections/S_clinicalInformation_CRGM.sch"/>
        <include href="include/specificationsVolets/CANCER-CR-GM_2022.01/Sections/S_diagnosticConclusion_CRGM.sch"/>
        <include href="include/specificationsVolets/CANCER-CR-GM_2022.01/Sections/S_intraoperativeObservation_CRGM.sch"/>
        <include href="include/specificationsVolets/CANCER-CR-GM_2022.01/Sections/S_macroscopicObservation_CRGM.sch"/>
        <include href="include/specificationsVolets/CANCER-CR-GM_2022.01/Sections/S_microscopicObservation_CRGM.sch"/>
        <include href="include/specificationsVolets/CANCER-CR-GM_2022.01/Sections/S_procedureSteps_CRGM.sch"/>

        <!--Entrées spécifiques au CR-GM-->
        <include href="include/specificationsVolets/CANCER-CR-GM_2022.01/Entrees/E_problemOrganizer_CRGM.sch"/>
        <include href="include/specificationsVolets/CANCER-CR-GM_2022.01/Entrees/E_specimenProcedureSteps_CRGM.sch"/>

        <!--JDV spécifiques au CR-GM-->
        <include href="include/jeuxDeValeurs/CANCER-CR-GM_2022.01/JDV_Conditionnement-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/CANCER-CR-GM_2022.01/JDV_ClasseTherapie-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/CANCER-CR-GM_2022.01/JDV_ImpactMutation-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/CANCER-CR-GM_2022.01/JDV_MethodePreparationEchantillon-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/CANCER-CR-GM_2022.01/JDV_NatureFraction-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/CANCER-CR-GM_2022.01/JDV_NatureMaterielEtudie-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/CANCER-CR-GM_2022.01/JDV_Organe-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/CANCER-CR-GM_2022.01/JDV_QualificationFraction-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/CANCER-CR-GM_2022.01/JDV_RaisonNonRealisation-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/CANCER-CR-GM_2022.01/JDV_TypeConclusion-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/CANCER-CR-GM_2022.01/JDV_TypeHistoEtatTumoral-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/CANCER-CR-GM_2022.01/JDV_TypePrelevOrigine-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/CANCER-CR-GM_2022.01/JDV_TypeResultat-CISIS.sch"/>
        <include href="include/jeuxDeValeurs/CANCER-CR-GM_2022.01/JDV_StatutDoc-CISIS.sch"/>

        <!--Entete spécifiques au CR-GM-->
        <include href="include/specificationsVolets/CANCER-CR-GM_2022.01/Entete/Entete_CR-GM.sch"/>

        <phase id="CI-SIS_CANCER-CR-GM_2022.01">
        ...
        <pattern id="variables">
                ...
                <let name="JDV_Conditionnement-CISIS"
                        value="'../jeuxDeValeurs/jdv-conditionnement-cisis.xml'"/>
                <let name="JDV_ClasseTherapie-CISIS"
                        value="'../jeuxDeValeurs/jdv-classe-therapie-cisis.xml'"/>
                <let name="JDV_ImpactMutation-CISIS"
                        value="'../jeuxDeValeurs/jdv-impact-mutation-cisis.xml'"/>
                <let name="JDV_MethodePreparationEchantillon-CISIS"
                        value="'../jeuxDeValeurs/jdv-methode-preparation-echantillon-cisis.xml'"/>
                <let name="JDV_NatureFraction-CISIS"
                        value="'../jeuxDeValeurs/jdv-nature-fraction-cisis.xml'"/>
                <let name="JDV_NatureMaterielEtudie-CISIS"
                        value="'../jeuxDeValeurs/jdv-nature-materiel-etudie-cisis.xml'"/>
                <let name="JDV_Organe-CISIS" value="'../jeuxDeValeurs/jdv-organe-cisis.xml'"/>
                <let name="JDV_QualificationFraction-CISIS"
                        value="'../jeuxDeValeurs/jdv-qualification-fraction-cisis.xml'"/>
                <let name="JDV_RaisonNonRealisation-CISIS"
                        value="'../jeuxDeValeurs/jdv-raison-non-realisation-cisis.xml'"/>
                <let name="JDV_TypeConclusion-CISIS"
                        value="'../jeuxDeValeurs/jdv-type-conclusion-cisis.xml'"/>
                <let name="JDV_TypeHistoEtatTumoral-CISIS"
                        value="'../jeuxDeValeurs/jdv-type-histo-etat-tumoral-cisis.xml'"/>
                <let name="JDV_TypePrelevOrigine-CISIS"
                        value="'../jeuxDeValeurs/jdv-type-pelevement-origine-cisis.xml'"/>
                <let name="JDV_TypeResultat-CISIS"
                        value="'../jeuxDeValeurs/jdv-type-resultat-cisis.xml'"/>
                ...
                <rule context='*[cda:templateId/@root="1.2.250.1.213.1.1.1.32"]'>
                        ...
                        <assert test="./cda:code[@code='51969-4' and @codeSystem='2.16.840.1.113883.6.1']"> 
                                [CI-SIS_CANCER-CR-GM_2022.01] : Erreur de conformité : L'élément
                        ...
                        <assert test='.//cda:templateId[@root = "1.3.6.1.4.1.19376.1.8.1.2.1"]'>
                                [CI-SIS_CANCER-CR-GM_2022.01] Erreur de conformité : 
